                ...
                {/* {!this.state.signUp ? */}
                    <div className='fields'>
                        <div className='username'>
                            ...
                            <input required className='user-input' onChange={this.fieldChange} type='username' id={inputLabels.inputValue} placeholder={inputLabels.labelValue} name={inputLabels.inputValue}/></div>
